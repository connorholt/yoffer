    ...
    <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse-1" class="panel-collapse collapse">
                        ...
                        <div class="panel-footer">
                            <div class="btn-group btn-group-xs"><span class="btn">Полезный вопрос?</span><a class="btn btn-success" href="#"><i class="fa fa-thumbs-up"></i> Да</a> <a class="btn btn-danger" href="#"><i class="fa fa-thumbs-down"></i> Нет</a></div>
                            <div class="btn-group btn-group-xs pull-right"><a class="btn btn-primary" href="#">Узнать ответ</a></div>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                               href="#collapse-2">
                                Что такое нормированная база данных?
                            </a>
                        </h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                               href="#collapse-3">
                                В чем отличие mysql myisam от innodb?
                            </a>
                        </h4>
                    </div>
        ...
        <div class="col-md-3">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item active">Базы данных</a>
                <a href="#" class="list-group-item">NoSQL</a>
                <a href="#" class="list-group-item">PHP</a>
                <a href="#" class="list-group-item">JavaScript</a>
                <a href="#" class="list-group-item">ООП</a>
                <a href="#" class="list-group-item">Кеширование</a>
                <a href="#" class="list-group-item">Общие вопросы</a>
            </div>
        </div>
    </div>
</div>